    ...
    <tr>
      <td colspan="4" align="center"><table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">
        <tr>
          ...
          <td width="382" bgcolor='#CCFFFF'>评论内容</td>
          <td width="54" bgcolor='#CCFFFF'>评论人</td>
...
%>
   ...
   %>
    ...
    <td colspan="4" align="center"><input type="button" name="Submit5" value="返回" onClick="javascript:history.back()" />
      <input type="button" name="Submit522" value="我要评论" onClick="javascript:location.href='pinglunadd.jsp?id=<%=id%>';" /></td>
  </tr>
                          </table>
                          <p align="center">&nbsp;</p>
</td>

...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>标题</td><td bgcolor='#CCFFFF'>类别</td><td bgcolor='#CCFFFF'>添加人</td><td bgcolor='#CCFFFF'>首页图片</td><td bgcolor='#CCFFFF'>点击率</td>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xinwentongzhi_list2.jsp?page=1&lb=<%=lb%>">首页</a>　<a href="xinwentongzhi_list2.jsp?page=<%= curpage-1%>&lb=<%=lb%>">上一页</a>　<A href="xinwentongzhi_list2.jsp?page=<%= curpage+1%>&lb=<%=lb%>">下一页</A>　<a href="xinwentongzhi_list2.jsp?page=<%=zys %>&lb=<%=lb%>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
